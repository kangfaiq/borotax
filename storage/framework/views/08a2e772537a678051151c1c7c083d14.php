    ...
    <div class="page">
                ...
                <td style="width: 25%; padding: 4px;">
                    <div style="text-align: center; font-weight: bold; margin-bottom: 10px;">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tax->masa_pajak_bulan): ?>
                            <?php echo e($tax->masa_pajak_bulan); ?> - <?php echo e($tax->masa_pajak_tahun); ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($pembetulanKe) && $pembetulanKe > 0): ?>
                        <div style="text-align: center; margin-bottom: 5px;">
                            ...
                            Pembetulan Ke-<?php echo e($pembetulanKe); ?>
        ...
        <table style="margin-bottom: 2px;">
            ...
            <tr>
                ...
                <td colspan="2">
                    <?php echo e(strtoupper($taxObject->nama_objek_pajak ?? '-')); ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isMblbTax && isset($mblbDetails) && $mblbDetails->count() > 0): ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isPembetulan): ?>
            <table style="margin-bottom: 0; border-top: none;">
                ...
                <tr>
                    ...
                    <td class="right"><?php echo e(number_format($sisaPokok, 0, ',', '.')); ?></td>
                </tr>
                <tr>
...
</html><?php /**PATH F:\Worx\laragon\www\borotax\resources\views/documents/sptpd.blade.php ENDPATH**/ ?>