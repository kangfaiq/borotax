    ...
    <div class="page">
        ...
        <table style="margin-bottom: 0; border-top: none;">
            <tr>
                ...
                <td style="border-top: none;">: <?php echo e($stpdDocumentNumber ?? $tax->stpd_number ?? '-'); ?></td>
            </tr>
            <tr>
                <td>Kode Billing Penagihan</td>
                <td>: <?php echo e($stpdPaymentCode ?? $tax->billing_code ?? '-'); ?></td>
            </tr>
            <tr>
                <td>Masa/Tahun Pajak</td>
                <td>:
                    <?php echo e($tax->masa_pajak_bulan ? \Carbon\Carbon::create()->month($tax->masa_pajak_bulan)->translatedFormat('F') : '-'); ?>
        ...
        <table style="margin-bottom: 0; border-top: none;">
            ...
            <tr>
                ...
                <td><?php echo e(strtoupper($taxObject->nama_objek_pajak ?? '-')); ?></td>
            </tr>
            <tr>
        ...
        <table style="margin-bottom: 0; border-top: none;">
            ...
            <tr class="bold">
                ...
                <td class="right"><?php echo e(number_format((float) $tax->omzet, 0, ',', '.')); ?></td>
            </tr>
        </table>
        ...
        <table style="margin-bottom: 0; border-top: none;">
            ...
            <tr>
                <td rowspan="<?php echo e($isMblbTax ? 4 : 3); ?>" class="center bold" style="vertical-align: middle;">Pokok<br>Pajak</td>
                <td>1. &nbsp;Pokok Pajak yang harus dibayar</td>
                <td class="right"><?php echo e(number_format($pokokPajak, 0, ',', '.')); ?></td>
            </tr>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isMblbTax): ?>
            <tr>
            ...
            <tr>
                <td>3. &nbsp;Total Pajak yang telah dibayar<br>
                    <span style="font-size: 9pt; font-style: italic;">&nbsp;&nbsp;&nbsp;&nbsp;(tanggal bayar pokok
                        pajak: <?php echo e($tglBayarPokok); ?>)</span>
                </td>
                <td class="right"><?php echo e(number_format($telahDibayar, 0, ',', '.')); ?></td>
            </tr>
            <tr>
                <td>4. &nbsp;Pajak yang masih harus dibayar (1+2-3)</td>
                <td class="right"><?php echo e(number_format($masihHarusDibayarPokok, 0, ',', '.')); ?></td>
            </tr>
            <?php else: ?>
            <tr>
            ...
            <tr>
                ...
                <td><?php echo e($isMblbTax ? '5' : '4'); ?>. &nbsp;Sanksi administratif bunga Pasal 131<br>
                    &nbsp;&nbsp;&nbsp;&nbsp;ayat (4) Perda 5/2023 jo. Perda 8/2025<br>
                    <span style="font-size: 9pt; font-style: italic;">&nbsp;&nbsp;&nbsp;&nbsp;(<?php echo e($tarifPersen); ?>% x
                        <?php echo e($bulanTerlambat); ?>bln x Pokok)</span>
                </td>
                <td class="right"><?php echo e(number_format($sanksiNominal, 0, ',', '.')); ?></td>
            </tr>
            <tr>
                <td class="center bold" style="vertical-align: middle;">Jumlah</td>
                <td class="bold"><?php echo e($isMblbTax ? '6' : '5'); ?>. &nbsp;Jumlah yang masih harus dibayar (<?php echo e($isMblbTax ? '4+5' : '3+4'); ?>)</td>
                <td class="right bold"><?php echo e(number_format($jumlahBayar, 0, ',', '.')); ?></td>
            </tr>
        </table>
        ...
        <table style="margin-bottom: 0; border-top: none;">
            <tr>
                ...
                <td style="border-top: none;">:
                    <?php echo e($tax->payment_expired_at ? \Carbon\Carbon::parse($tax->payment_expired_at)->translatedFormat('d F Y') : '-'); ?>
        ...
        <table style="border-top: none;">
            <tr>
                <td style="border-top: none; padding: 6px;">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($stpdManual) && $stpdManual->tipe === 'pokok_sanksi'): ?>
                    Terdapat pokok pajak yang belum dibayar sebesar <strong>Rp <?php echo e(number_format((float) $stpdManual->pokok_belum_dibayar, 0, ',', '.')); ?></strong>
                    beserta sanksi administratif sebesar <strong>Rp <?php echo e(number_format((float) $stpdManual->sanksi_dihitung, 0, ',', '.')); ?></strong>
                    (proyeksi s.d. tanggal <?php echo e($stpdManual->proyeksi_tanggal_bayar?->translatedFormat('d F Y') ?? '-'); ?>).
                    Wajib Pajak diharapkan segera melunasi seluruh tagihan pajak daerah tersebut.
                    <?php elseif(!empty($isSanksiBelumLunas) && ($sanksiBelumDibayar ?? 0) > 0): ?>
                    Terdapat sanksi administratif yang belum terbayarkan sebesar <strong>Rp <?php echo e(number_format($sanksiBelumDibayar, 0, ',', '.')); ?></strong>.
...
</html><?php /**PATH F:\Worx\laragon\www\borotax\resources\views/documents/stpd.blade.php ENDPATH**/ ?>