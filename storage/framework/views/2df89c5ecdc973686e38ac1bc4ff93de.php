...
<?php $__env->startSection('title', 'Borotax - Portal Pajak Online Kabupaten Bojonegoro'); ?>
...
<?php $__env->startSection('nav-links'); ?>
    ...
    <div class="navbar-dropdown">
        ...
        <div class="navbar-dropdown-menu">
            <a href="<?php echo e(url('/sewa-reklame')); ?>"><i class="bi bi-megaphone"></i> Sewa Reklame</a>
            <a href="<?php echo e(url('/kalkulator-sanksi')); ?>"><i class="bi bi-calculator"></i> Kalkulator Sanksi</a>
            <a href="<?php echo e(url('/produk-hukum')); ?>"><i class="bi bi-journal-bookmark"></i> Produk Hukum</a>
            <a href="<?php echo e(url('/kalkulator-air-tanah')); ?>"><i class="bi bi-droplet"></i> Kalkulator Air Tanah</a>
            <a href="<?php echo e(url('/kalkulator-reklame')); ?>"><i class="bi bi-easel"></i> Kalkulator Reklame</a>
        </div>
    </div>
    <a href="<?php echo e(url('/destinasi')); ?>">Wisata</a>
    <a href="<?php echo e(url('/berita')); ?>">Berita</a>
    <a href="<?php echo e(url('/cek-billing')); ?>">Cek Billing</a>
    <a href="<?php echo e(url('/login')); ?>" class="navbar-cta">Login Wajib Pajak</a>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('nav-mobile-links'); ?>
    <a href="#layanan">Layanan</a>
    <a href="#cara-kerja">Cara Kerja</a>
    ...
    <a href="<?php echo e(url('/berita')); ?>">Berita</a>
    <a href="<?php echo e(url('/cek-billing')); ?>">Cek Billing</a>
    <a href="<?php echo e(url('/login')); ?>">Login Wajib Pajak</a>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
                    ...
                    <div class="hero-mini-stats">
                        <div class="hero-mini-stat">
                            ...
                            <div class="hero-mini-stat-text">
                                <div class="num" id="stat-wp"><?php echo e($totalWp ?? 0); ?>+</div>
        ...
        <div class="container">
            ...
            <div class="grid-4">
                <div class="feature-card reveal">
                    ...
                    <a href="<?php echo e(url('/login')); ?>" class="feature-link">Selengkapnya <i class="bi bi-arrow-right"></i></a>
                </div>
                <div class="feature-card reveal">
        ...
        <div class="container">
            <div class="showcase-grid reveal">
                ...
                <div>
                    ...
                    <a href="<?php echo e(url('/login')); ?>" class="btn btn-primary">Masuk Dashboard <i class="bi bi-arrow-right"></i></a>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="showcase-grid reverse reveal">
                ...
                <div>
                    ...
                    <a href="<?php echo e(url('/cek-billing')); ?>" class="btn btn-primary">Cek Billing Sekarang <i class="bi bi-arrow-right"></i></a>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="grid-3" style="max-width: 960px; margin: 0 auto;">
                <div class="feature-card reveal">
                    ...
                    <a href="<?php echo e(url('/sewa-reklame')); ?>" class="feature-link">Lihat Aset <i class="bi bi-arrow-right"></i></a>
                </div>
                <div class="feature-card reveal">
                    ...
                    <a href="<?php echo e(url('/kalkulator-sanksi')); ?>" class="feature-link">Hitung Sekarang <i class="bi bi-arrow-right"></i></a>
                </div>
                <div class="feature-card reveal">
                    ...
                    <a href="<?php echo e(url('/produk-hukum')); ?>" class="feature-link">Lihat Dokumen <i class="bi bi-arrow-right"></i></a>
                </div>
                <div class="feature-card reveal" style="grid-column: 1 / 2;">
                    ...
                    <a href="<?php echo e(url('/kalkulator-air-tanah')); ?>" class="feature-link">Hitung Sekarang <i class="bi bi-arrow-right"></i></a>
                </div>
                <div class="feature-card reveal">
                    ...
                    <a href="<?php echo e(url('/kalkulator-reklame')); ?>" class="feature-link">Hitung Sekarang <i class="bi bi-arrow-right"></i></a>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="stats-grid">
                <div class="stat-item reveal">
                    ...
                    <div class="stat-number" data-target="<?php echo e($totalWp ?? 150); ?>">0</div>
                ...
                <div class="stat-item reveal">
                    ...
                    <div class="stat-number" data-target="<?php echo e($totalDestinations ?? 12); ?>">0</div>
        ...
        <div class="container">
            <div class="billing-card reveal">
                ...
                <div class="billing-form-wrap">
                    ...
                    <form action="<?php echo e(url('/cek-billing')); ?>" method="GET">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($news) && $news->count() > 0): ?>
            ...
            <div class="container">
                ...
                <div class="grid-3">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $news; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('publik.berita.show', $item)); ?>" class="news-card reveal" style="text-decoration:none;color:inherit;">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->image_url): ?>
                                <img src="<?php echo e(asset($item->image_url)); ?>" alt="<?php echo e($item->title); ?>" class="news-card-img">
                            <?php else: ?>
                            ...
                            <div class="news-card-body">
                                <div class="news-card-date">
                                    ...
                                    <?php echo e(\Carbon\Carbon::parse($item->published_at ?? $item->created_at)->format('d M Y')); ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($destinations) && $destinations->count() > 0): ?>
        <section class="dest-section" id="destinations">
            <div class="container">
                ...
                <div class="grid-3">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $destinations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dest): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="dest-card reveal">
                            <a href="<?php echo e(route('publik.destinasi.show', $dest)); ?>">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($dest->image_url): ?>
                                    <img src="<?php echo e(asset($dest->image_url)); ?>" alt="<?php echo e($dest->name); ?>" class="dest-card-img">
                                <?php else: ?>
                                ...
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <span class="dest-cat-badge cat-<?php echo e($dest->category); ?>"><?php echo e($dest->category_label); ?></span>
                                <span class="dest-badge"><i class="bi bi-geo-alt-fill"></i> Bojonegoro</span>
                                <div class="dest-card-body">
                                    <h3><?php echo e($dest->name); ?></h3>
                                    <p><?php echo e(str()->limit($dest->description, 80)); ?></p>
                                    <div class="dest-card-meta">
                                        <span class="dest-card-rating"><i class="bi bi-star-fill"></i> <?php echo e(number_format($dest->rating, 1)); ?></span>
                                        <span class="dest-card-reviews">(<?php echo e($dest->review_count); ?> ulasan)</span>
                                    </div>
                                </div>
                            </a>
                        </div>
                ...
                <div class="dest-view-all reveal">
                    <a href="<?php echo e(url('/destinasi')); ?>"><i class="bi bi-compass"></i> Lihat Semua Destinasi</a>
                </div>
            </div>
        </section>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php echo $__env->make('layouts.portal-guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Worx\laragon\www\borotax\resources\views/landing.blade.php ENDPATH**/ ?>