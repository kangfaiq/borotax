...
<head>
    ...
    <title><?php echo e(strtoupper($letter->letter_type->value)); ?> - BoroTax</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="page">
        ...
        <table class="kop-table" style="margin-bottom: 2px;">
            <tr>
                <td style="width: 20%; text-align: center; border-right: none;">
                    <img src="<?php echo e($isPdf ?? true ? public_path('images/logo-pemkab.png') : asset('images/logo-pemkab.png')); ?>"
                        style="width: 130px;">
                </td>
        ...
        <table style="margin-bottom: 0; border-top: none;">
            <tr>
                ...
                <td style="border-top: none;">: <?php echo e($letter->document_number ?? '-'); ?></td>
            </tr>
            <tr>
                <td>Masa/Tahun Pajak</td>
                <td>: <?php echo e($masaPajak); ?></td>
            </tr>
        </table>
        ...
        <table style="margin-bottom: 0; border-top: none;">
            <tr>
                ...
                <td style="border-top: none;"><?php echo e($wajibPajak->npwpd ?? '-'); ?></td>
            </tr>
            <tr>
                <td style="font-weight: bold;">Nama Wajib Pajak</td>
                <td><?php echo e(strtoupper($wajibPajak->nama_lengkap ?? '-')); ?></td>
            </tr>
            <tr>
                <td style="font-weight: bold;">Alamat</td>
                <td><?php echo e($wajibPajak->alamat ?? '-'); ?></td>
            </tr>
        </table>
        ...
        <table style="margin-bottom: 0; border-top: none;">
            ...
            <tr>
                ...
                <td><?php echo e(strtoupper($taxObject->nama_usaha ?? $taxObject->nama_objek_pajak ?? '-')); ?></td>
            </tr>
            <tr>
                <td style="font-weight: bold;">Alamat Objek Pajak</td>
                <td><?php echo e($taxObject->alamat_objek ?? '-'); ?></td>
            </tr>
        </table>

        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($letter->letter_type === \App\Enums\TaxAssessmentLetterType::SKPDLB): ?>
        ...
        <table style="margin-bottom: 0; border-top: none;">
            ...
            <tr>
                ...
                <td class="right"><?php echo e(number_format($pajakSeharusnya, 0, ',', '.')); ?></td>
            </tr>
            <tr>
                <td>
                    2. &nbsp;Jumlah kredit pajak / pajak yang telah dibayar
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tax?->paid_at): ?>
                        <br><span style="font-size: 9pt; font-style: italic;">&nbsp;&nbsp;&nbsp;&nbsp;(tanggal bayar: <?php echo e($tax->paid_at->format('d/m/Y')); ?>)</span>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </td>
                <td class="right"><?php echo e(number_format($taxPaid, 0, ',', '.')); ?></td>
            </tr>
            <tr>
                <td class="bold">3. &nbsp;Kelebihan pembayaran pajak (2-1)</td>
                <td class="right bold"><?php echo e(number_format($baseAmount, 0, ',', '.')); ?></td>
            </tr>
            ...
            ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($kompensasiEmpty): ?>
            <tr>
                <td rowspan="<?php echo e($kompensasiRowspan); ?>" class="center bold" style="vertical-align: middle;">Kompen&shy;sasi</td>
                <td><?php echo e($kompNo++); ?>. &nbsp;Dikompensasikan ke billing lain</td>
                <td class="right">-</td>
            </tr>
            <?php else: ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $kompensasiList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kompensasi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <td rowspan="<?php echo e($kompensasiRowspan); ?>" class="center bold" style="vertical-align: middle;">Kompen&shy;sasi</td>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <td><?php echo e($kompNo++); ?>. &nbsp;Dikompensasikan ke billing <?php echo e($kompensasi->targetTax?->billing_code ?? '-'); ?></td>
                <td class="right"><?php echo e(number_format((float) ($kompensasi->allocation_amount ?? 0), 0, ',', '.')); ?></td>
            </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <tr>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($kompensasiEmpty): ?><td class="center bold" style="vertical-align: middle;"></td><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <td class="bold"><?php echo e($kompNo); ?>. &nbsp;Sisa kredit yang tersedia</td>
                <td class="right bold"><?php echo e(number_format((float) ($letter->available_credit ?? 0), 0, ',', '.')); ?></td>
            </tr>
        </table>
        ...
        <table style="margin-bottom: 0; border-top: none;">
            <tr>
                <td style="border-top: none; padding: 4px 6px;">
                    ...
                    <?php echo e(ucwords(\NumberFormatter::create('id_ID', \NumberFormatter::SPELLOUT)->format(abs($baseAmount)))); ?> Rupiah
                </td>
            </tr>
        </table>
        ...
        <table style="border-top: none;">
            <tr>
                <td style="border-top: none; padding: 6px;">
                    ...
                    Kelebihan pembayaran pajak sebesar <?php echo e($letter->letter_type->getLabel()); ?> ini dapat dikompensasikan ke tagihan pajak lain
                    atau dimohonkan restitusi sesuai ketentuan peraturan perundang-undangan yang berlaku.
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($letter->notes): ?>
                        <br><em><?php echo e($letter->notes); ?></em>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </td>
            </tr>
        </table>
        ...
        <table style="margin-bottom: 0; border-top: none;">
            ...
            <tr>
                ...
                <td class="right"><?php echo e(number_format($baseAmount, 0, ',', '.')); ?></td>
            </tr>
            <tr>
                <td>
                    2. &nbsp;Pokok Pajak yang telah dibayar
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tax?->paid_at): ?>
                        <br><span style="font-size: 9pt; font-style: italic;">&nbsp;&nbsp;&nbsp;&nbsp;(tanggal bayar pokok pajak: <?php echo e($tax->paid_at->format('d/m/Y')); ?>)</span>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </td>
                <td class="right"><?php echo e(number_format($taxPaid, 0, ',', '.')); ?></td>
            </tr>
            <tr>
                ...
                <td class="right"><?php echo e(number_format($pokokSisa, 0, ',', '.')); ?></td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($letter->interest_rate > 0 && $letter->interest_months > 0): ?>
                        <br><span style="font-size: 9pt; font-style: italic;">&nbsp;&nbsp;&nbsp;&nbsp;(<?php echo e(number_format((float) $letter->interest_rate, 1, ',', '.')); ?>% x <?php echo e($letter->interest_months); ?>bln x Pokok)</span>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </td>
                <td class="right"><?php echo e(number_format($interestAmount, 0, ',', '.')); ?></td>
            </tr>
            <tr>
            ...
            <tr>
                <td>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($letter->surcharge_rate > 0): ?>
                        <br><span style="font-size: 9pt; font-style: italic;">&nbsp;&nbsp;&nbsp;&nbsp;(<?php echo e(number_format((float) $letter->surcharge_rate, 0, ',', '.')); ?>% x Pokok)</span>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </td>
                <td class="right"><?php echo e(number_format($surchargeAmount, 0, ',', '.')); ?></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="right bold"><?php echo e(number_format($totalSanksi, 0, ',', '.')); ?></td>
            </tr>
            ...
            <tr>
                ...
                <td class="right bold"><?php echo e(number_format($totalAssessment, 0, ',', '.')); ?></td>
            </tr>
        </table>
        ...
        <table style="margin-bottom: 0; border-top: none;">
            <tr>
                <td style="border-top: none; padding: 4px 6px;">
                    <strong>Terbilang</strong> &nbsp;:&nbsp;
                    <?php echo e(ucwords(\NumberFormatter::create('id_ID', \NumberFormatter::SPELLOUT)->format(abs($totalAssessment)))); ?> Rupiah
                </td>
            </tr>
        </table>
        ...
        <table style="margin-bottom: 0; border-top: none;">
            <tr>
                ...
                <td style="border-top: none;">: <?php echo e($generatedTax?->billing_code ?? $tax?->billing_code ?? '-'); ?></td>
            </tr>
        </table>
        ...
        <table style="border-top: none;">
            <tr>
                <td style="border-top: none; padding: 6px;">
                    <strong>III. Perhatian</strong><br>
                    Jumlah yang masih harus dibayar pada dokumen <?php echo e($letter->letter_type->getLabel()); ?> ini wajib dilunasi dalam jangka waktu
        ...
        <table class="footer-table" style="width: 100%; margin-top: 15px;">
            <tr>
                ...
                <td style="width: 45%; text-align: center; font-size: 10pt;">
                    Bojonegoro, <?php echo e($letter->verified_at ? $letter->verified_at->translatedFormat('d F Y') : ($letter->issue_date ? $letter->issue_date->translatedFormat('d F Y') : \Carbon\Carbon::now()->translatedFormat('d F Y'))); ?><br>
...
</html><?php /**PATH F:\Worx\laragon\www\borotax\resources\views/documents/tax-assessment-letter.blade.php ENDPATH**/ ?>