<x-filament-panels::page>
    ...
    @if($totalMenunggu > 0)
        ...
        <div class="verif-grid">
            ...
            @if($reklameMenunggu > 0)
                <a href="{{ App\Filament\Resources\PermohonanSewaReklameResource::getUrl('index') }}" class="verif-card">
                    <div class="verif-info">
                        <div class="verif-dot pulse" style="background: #8b5cf6;"></div>
                        <span class="verif-label">Pengajuan Reklame</span>
                    </div>
    ...
    <div class="quick-actions">
        {{-- Fitur Buat Billing SA dinonaktifkan sementara --}}
