                ...
                <div class="grid">
                    @foreach($items as $item)
                        <article class="card">
                            ...
                            <div class="actions">
                                <a class="btn btn-primary" href="{{ route('document-previews.show', $item['slug']) }}" target="_blank" rel="noopener noreferrer">
                                    Buka Preview
                                </a>
                                <a class="btn btn-secondary" href="{{ route('document-previews.show', $item['slug']) }}?download=1">
                                    Unduh PDF
                                </a>
                            </div>
                        </article>
