...
@section('title', 'SKPD Reklame - Borotax Portal')
@section('page-title', 'Dokumen SKPD Reklame')
...
@section('content')
    ...
    {{-- Tabs --}}
    <div class="skpd-tabs">
        <a href="{{ route('portal.reklame.skpd-list', ['tab' => 'selesai']) }}"
           class="skpd-tab {{ $tab === 'selesai' ? 'active' : '' }}">
            Selesai
        </a>
        <a href="{{ route('portal.reklame.skpd-list', ['tab' => 'proses']) }}"
    ...
    @if($skpds->isEmpty())
        <div class="empty-state">
            ...
            <p>
                ...
                @else
                    SKPD akan muncul setelah pengajuan perpanjangan Anda diverifikasi petugas.
                @endif
            </p>
        </div>
    @else
        <div class="skpd-list">
            @foreach($skpds as $skpd)
                ...
                @endphp
                <a href="{{ route('portal.reklame.skpd-detail', $skpd->id) }}" class="skpd-card">
                    <div class="skpd-card-top">
                        ...
                        <div class="skpd-card-info">
                            ...
                            <div class="skpd-card-objek">{{ $skpd->reklameObject?->nama_reklame ?? 'Objek Reklame' }}</div>
                            <div class="skpd-card-meta">
                                ...
                                <span>
                                    ...
                                    {{ $skpd->luas_m2 }} m² × {{ $skpd->jumlah_muka }} muka
                                </span>
                                <span>
                                    <i class="bi bi-clock"></i>
                                    {{ $skpd->durasi ?? '-' }} {{ $skpd->satuan_waktu ?? '' }}
                                </span>
                            </div>
                        </div>
