...
<head>
    ...
    <title>@yield('title', 'Borotax - Portal Pajak Online Bojonegoro')</title>
...
<body>
    {{-- Navbar --}}
    <nav class="navbar @yield('navbar-class')" id="navbar">
        <div class="container navbar-inner">
            <a href="{{ url('/') }}" class="navbar-logo">
                @if(file_exists(public_path('images/logo-pemkab.png')))
                    <img src="{{ asset('images/logo-pemkab.png') }}" alt="Logo Pemkab Bojonegoro">
                @endif
    ...
    <footer class="footer">
        <div class="container">
            <div class="footer-top">
                ...
                <div>
                    ...
                    <ul class="footer-link-list">
                        <li><a href="{{ url('/cek-billing') }}"><i class="bi bi-chevron-right" style="font-size:0.7rem;"></i> Cek Billing</a></li>
                        <li><a href="{{ url('/login') }}"><i class="bi bi-chevron-right" style="font-size:0.7rem;"></i> Portal Wajib Pajak</a></li>
                        <li><a href="{{ url('/sewa-reklame') }}"><i class="bi bi-chevron-right" style="font-size:0.7rem;"></i> Sewa Reklame</a></li>
                        <li><a href="{{ url('/kalkulator-sanksi') }}"><i class="bi bi-chevron-right" style="font-size:0.7rem;"></i> Kalkulator Sanksi</a></li>
                        <li><a href="{{ url('/kalkulator-reklame') }}"><i class="bi bi-chevron-right" style="font-size:0.7rem;"></i> Kalkulator Reklame</a></li>
                    </ul>
                </div>
                <div>
                    <h4 class="footer-heading">Informasi</h4>
                    <ul class="footer-link-list">
                        <li><a href="{{ url('/produk-hukum') }}"><i class="bi bi-chevron-right" style="font-size:0.7rem;"></i> Produk Hukum</a></li>
                        <li><a href="{{ url('/kalkulator-air-tanah') }}"><i class="bi bi-chevron-right" style="font-size:0.7rem;"></i> Kalkulator Air Tanah</a></li>
                        <li><a href="{{ url('/berita') }}"><i class="bi bi-chevron-right" style="font-size:0.7rem;"></i> Berita Terbaru</a></li>
                        <li><a href="{{ url('/destinasi') }}"><i class="bi bi-chevron-right" style="font-size:0.7rem;"></i> Destinasi Wisata</a></li>
                    </ul>
                </div>
                <div>
            ...
            <div class="footer-bottom">
                <p>&copy; {{ date('Y') }} Badan Pendapatan Daerah Kabupaten Bojonegoro. All rights reserved.</p>
